  ...
  return (
    <div className="bg-white w-full select-none">
      <div className="flex flex-col-reverse lg:flex-row justify-between items-center max-w-7xl mx-auto px-4 py-16 gap-10">
        ...
        <div className="border-8 border-[var(--dark-blue)] rounded-[20px] w-[90%] sm:w-[80%] md:w-[300px] lg:w-[350px] h-[400px] md:h-[500px] relative">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          <button className="mb-4 px-6 py-2 bg-[var(--dark-blue)] text-white font-semibold text-sm tracking-widest rounded-full">
            ABOUT US
          </button>
